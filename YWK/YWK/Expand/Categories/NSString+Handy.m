...
+ (CGFloat)widthWithText:(NSString *)text andFontSize:(CGFloat)fontSize{
    CGRect rect =
    [text boundingRectWithSize:CGSizeMake(MAXFLOAT, 20)
...
+ (CGFloat)heightWithText:(NSString *)text andFontSize:(CGFloat)fontSize{
    CGRect rect =
    [text boundingRectWithSize:CGSizeMake(SCREEN_WIDTH - 20, MAXFLOAT)
                       options:NSStringDrawingUsesLineFragmentOrigin
                    attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:fontSize]}
                       context:nil];
...
- (CGFloat)heightWithWidth:(CGFloat)w andFontSize:(CGFloat)fontSize{
    CGRect rect =
    [self boundingRectWithSize:CGSizeMake(w, MAXFLOAT)
                       options:NSStringDrawingUsesLineFragmentOrigin
                    attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:fontSize]}
                       context:nil];
    return rect.size.height;
