...
- (void)setImage:(UIImage *)image withTitle:(NSString *)title forState:(UIControlState)stateType {
    ...
    [self setTitleEdgeInsets:UIEdgeInsetsMake(image.size.height+10 ,
                                              -image.size.width,
                                              0.0,
                                              0.0)];
    ...
    [self setTitleColor:APP_COLOR_GRAY_333333 forState:UIControlStateNormal];
}
...
- (void)setDefaultSelectedStyle{
    [self setBackgroundImage:[UIImage imageNamed:@"btn_Sel"] forState:UIControlStateHighlighted];
