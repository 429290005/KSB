...
@property (nonatomic, strong) NSArray *answerExplain;
...
- (void)viewDidLoad {
    ...
    NSString *plistPath = [[NSBundle mainBundle] pathForResource:@"SelectQuestions" ofType:@"plist"];
    NSMutableDictionary *usersDic = [[NSMutableDictionary alloc]initWithContentsOfFile:plistPath];
    NSArray *contentArr = usersDic[@"content"];
    NSNumber * type = self.myDict[@"type"];
    NSString *str = contentArr[[type integerValue]];
    NSString *index = [NSString stringWithFormat:@"。"];
    NSArray *array6 = [str componentsSeparatedByString:index];
    
//    NSLog(@"%@",describe(array6));
...
//        NSLog(@"%@",describe(array));
        
        NSArray *array1 = [array[1] componentsSeparatedByString:@"B."];
        
        NSString *A = [NSString stringWithFormat:@"A.%@",array1[0]];
        
        NSArray *array2 = [array1[1] componentsSeparatedByString:@"C."];
        
        NSString *B = [NSString stringWithFormat:@"B.%@",array2[0]];
        
        NSArray *array3 = [array2[1] componentsSeparatedByString:@"D."];
        
        NSString *C = [NSString stringWithFormat:@"C.%@",array3[0]];
        
        NSString *D = [NSString stringWithFormat:@"D.%@",array3[1]];
    ...
    NSString *plistPath1 = [[NSBundle mainBundle] pathForResource:@"Answers" ofType:@"plist"];
    NSMutableDictionary *usersDic1 = [[NSMutableDictionary alloc]initWithContentsOfFile:plistPath1];
    NSArray *contentArr1 = usersDic1[@"answer"];
    NSNumber * type1 = self.myDict[@"type"];
    NSString *str1 = contentArr1[[type1 integerValue]];
    NSString *str2 = [str1 stringByReplacingOccurrencesOfString:@"					" withString:@"."];
    self.rightAnswer = [str2 componentsSeparatedByString:@"."];
    
    NSString *plistPath2 = [[NSBundle mainBundle] pathForResource:@"AnswerExplain" ofType:@"plist"];
    NSMutableDictionary *usersDic2 = [[NSMutableDictionary alloc]initWithContentsOfFile:plistPath2];
    NSArray *contentArr2 = usersDic2[@"content"];
    NSNumber * type2 = self.myDict[@"type"];
    NSString *str3 = contentArr2[[type2 integerValue]];
    NSString *str4 = [str3 stringByReplacingOccurrencesOfString:@"					" withString:@"."];
    self.answerExplain = [str4 componentsSeparatedByString:@"."];
    
    
//    NSLog(@"%ld---------%ld",self.rightAnswer.count,self.answerExplain.count);
...
- (UIView *)headView{
    if (!_headView) {
        ...
        UILabel *content = [UILabel createLabelWithFrame:CommonVIEWFRAME(0, 0, 0, 0)
                                       andText:self.titleArr[self.index]
                                  andTextColor:[UIColor blackColor]
                                    andBgColor:[UIColor clearColor]
                                       andFont:SYSTEMFONT(14)
...
{
//    NSLog(@"%@-------%@",self.rightAnswer[self.index],self.answerExplain[self.index]);
    if (self.isShowAnswer) {
        return;
    }
    ...
    NSNumber * type = self.myDict[@"type"];
    NSString *str = [NSString stringWithFormat:@"%ld",[type integerValue]];
    NSDictionary *dic1 = DEFAULTS_GET_OBJ(str);
//    NSMutableDictionary *dic = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *usersDic = [[NSMutableDictionary alloc] initWithDictionary:dic1];
    [usersDic setObject:@"1" forKey: [NSString stringWithFormat:@"%ld-%ld",[type integerValue],self.index]];
    DEFAULTS_SET_OBJ(usersDic, str);
...
//    NSLog(@"%@",plistPath);
    ...
    NSDictionary *dic2 = DEFAULTS_GET_OBJ(@"follow");
    NSNumber * type = self.myDict[@"type"];
    NSDictionary *dic1 = [dic2 valueForKey:[NSString stringWithFormat:@"%ld-%ld",[type integerValue],self.index]];
    if (dic1.count != 0) {
         [ProgressHUDHandler showHudTipStr:@"你已经收藏过本题"];
    }else{
        
        NSMutableDictionary *dic = [[NSMutableDictionary alloc] init];
        NSMutableDictionary *usersDic = [[NSMutableDictionary alloc] initWithDictionary:dic2];
        [dic setObject:self.titleArr[self.index] forKey:@"title"];
        NSArray *arr = self.answerArr[self.index];
        [dic setObject:arr forKey:@"answer"];
        [dic setObject:self.answerExplain[self.index] forKey:@"explain"];
